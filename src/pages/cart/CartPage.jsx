...
import Modal from "../../components/model/ModelPage";
...
const CartPage = () => {
  ...
  const deleteFromCart = (items) => {
    dispatch(deleteTOCart(items));
  ...
  useEffect(() => {
    ...
    cartItems.forEach((cartItems) => {
      prevAmnt = prevAmnt + parseInt(cartItems.price);
      setTotalAmount(prevAmnt);
    });
  }, [cartItems]);
  ...
  return (
    <LayoutPage>
      <div
        className={`overflow-y-scroll no-scrollbar bg-gray-100 pt-5 ${
